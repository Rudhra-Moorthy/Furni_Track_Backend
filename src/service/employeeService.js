...
const employee = require("../query/employeeQuery");
const { getEmploymentTypeId } = require("../service/employmentTypeService");
const { getDepartmentId } = require("../service/departmentService");
const { getDesignationId } = require("../service/designationService");
